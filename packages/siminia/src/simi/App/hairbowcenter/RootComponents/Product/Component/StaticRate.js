...
const StaticRate = props => {
    ...
    return (
        <div className={classes["static-rate"]} style={{width: width, position:'relative'}}>
            <FiveStars style={{width: width, height: height, fill:'#e0e0e0'}}/>
            <div className={classes["static-rate-active"]} style={{width: rateWidth, overflow: 'hidden', position: 'absolute', left: 0, top: 0}}>
