        ...
        if (config.product_detail_configs.social_share) {
            ...
            return (
                <div className={`rewardssocial-buttons`}>
                    ...
                    {<div className="status-message" id="status-message">{this.props.isSignedIn ? Identify.__('Earn Reward Points for sharing!') : Identify.__("Login to earn Reward Points for sharing!")}</div>}
                </div>
            );
        }
