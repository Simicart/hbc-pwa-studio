            ...
            <form id="address-form" >
                <div className="col-left">
                    ...
                    <div className="form-row">
                        ...
                        <input type="text" id='input-firstname' name='firstname' className='isrequired' defaultValue={addressData.firstname} />
                    </div>
                    <div className="form-row">
                        <div className='address-field-label req'>{Identify.__("Last Name")}</div>
                        <input type="text" id='input-lastname' name='lastname' className='isrequired' defaultValue={addressData.lastname} />
                    </div>
                    {(!addressConfig || (addressConfig && addressConfig.company_show)) &&
                        <div className="form-row">
                            ...
                            <input type="text" id='input-company' name='company' className={addressConfig && addressConfig.company_show === 'req' ? 'isrequired' : ''} defaultValue={addressData.company} />
                        </div>
                    }
                    {
                        (!addressConfig || (addressConfig && addressConfig.telephone_show)) &&
                        <div className="form-row">
                            <div className={`address-field-label req`}>{Identify.__("Phone Number")}</div>
                            <input type="text" id='input-telephone' name='telephone' className={'isrequired'} defaultValue={addressData.telephone} />
                        </div>
                    }

                    {/* <div className="form-row">
                        <div className={`address-field-label`}>{Identify.__("Fax")}</div>
                        <input type="text" id='input-fax' name='fax' defaultValue={addressData.telephone} />
                    </div> */}
                </div>
                <div className="col-right">
                    ...
                    {(!addressConfig || (addressConfig && addressConfig.street_show)) &&
                        <div className="form-row">
                            <div className={`address-field-label ${(!addressConfig || (addressConfig && addressConfig.street_show === 'req')) ? 'req' : ''}`}>{Identify.__("Street Address")}</div>
                            <input type="text" id='input-street1' name='street[0]' className={(!addressConfig || (addressConfig && addressConfig.street_show === 'req')) ? 'isrequired' : ''} defaultValue={addressData.street[0]} />
                    ...
                    {(!addressConfig || (addressConfig && addressConfig.city_show)) &&
                        <div className="form-row">
                            <div className={`address-field-label ${(!addressConfig || (addressConfig && addressConfig.city_show === 'req')) ? 'req' : ''}`}>{Identify.__("City")}</div>
                            <input type="text" id='input-city' name='city' className={(!addressConfig || (addressConfig && addressConfig.city_show === 'req')) ? 'isrequired' : ''} defaultValue={addressData.city} />
                        </div>
                    }

                    {(!addressConfig || (addressConfig && addressConfig.zipcode_show)) &&
                        <div className="form-row">
                            <div className={`address-field-label ${(!addressConfig || (addressConfig && addressConfig.zipcode_show === 'req')) ? 'req' : ''}`}>{Identify.__("Zip/Postal Code")}</div>
                            <input type="text" id='input-postcode' name='postcode' className={(!addressConfig || (addressConfig && addressConfig.zipcode_show === 'req')) ? 'isrequired' : ''} defaultValue={addressData.postcode} />
                        </div>
                    }

                    {(!addressConfig || (addressConfig && addressConfig.country_id_show)) &&
                        <div className="form-row">
                            <div className={`address-field-label ${(!addressConfig || (addressConfig && addressConfig.country_id_show === 'req')) ? 'req' : ''}`}>{Identify.__("Country")}</div>
                            <select
                                name="country_id"
                                ...
                                className={(!addressConfig || (addressConfig && addressConfig.country_id_show === 'req')) ? 'isrequired' : ''}
                            >
                                <option key='pls-select' value="">{Identify.__('Please choose')}</option>
                                {
